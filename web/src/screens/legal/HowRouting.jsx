    ...
    <Root className="hw hwroute" id={inApp ? undefined : 'main'}>
      ...
      <div className="hwsteps">
        ...
        <Step n={3} id="priority" title="The best are put in order" figure={<Priorities />}>
          <p>
            Several options can pass. Understudy puts the biggest saving it can count on first. With the default priority,
            a clear pass beats a narrow one only when their savings are close.
          </p>
